...
@section('content')
    ...
    <div class="showtab">
        <div class="box-01">
            <p><span><b>Công ty Nhung Quảng (NQ Mobile)</b></span> là nhà bán lẻ số 1 về điện thoại tại Việt Nam với phương
                châm luôn luôn đảm bảo về chất lượng và trải nghiệm của khách hàng. NQ Mobile luôn lắng nghe, thấu hiểu
                những góp ý của khách
                hàng và thay đổi để mang những gì tốt nhất đến với khách hàng của NQ Mobile. Sự ân cần và chu đáo của nhân
                viên là những lời khen mà khách hàng dành tặng cho NQ Mobile. </p>
            <ul>
                <li><span><b>NQ Mobile</b></span> tập trung xây dựng dịch vụ khách hàng khác biệt với chất lượng vượt trội,
                    phù
                    hợp với văn hoá đặt khách hàng làm trung tâm trong mọi suy nghĩ và hành động của công ty.</li>
                <li><span><b>NQ Mobile</b></span> vinh dự khi liên tiếp lọt vào bảng xếp hạng TOP 100 công ty niêm yết tốt
                    nhất
                    ...
                    bình chọn.</li>
                <li><b><span>NQ Mobile</span> </b>nhiều năm liền có tên trong các bảng xếp hạng danh giá như TOP 100 nhà
                    bán lẻ
                    hàng đầu Châu Á – Thái Bình Dương (Retail Asia) và dẫn đầu TOP 100 công ty kinh doanh hiệu quả nhất Việt
                    Nam (Nhịp Cầu Đầu Tư)… Sự phát triển của NQ Mobile cũng là một điển hình tốt được nghiên cứu tại các
                    trường
                ...
                <li>Không chỉ là một doanh nghiệp hoạt động hiệu quả được nhìn nhận bởi nhà đầu tư và các tổ chức đánh giá
                    chuyên nghiệp, <span><b>NQ Mobile</b></span> còn được người lao động tin yêu khi lần thứ 4 liên tiếp
                    được vinh
            ...
            <div class="block tgdd">
                <div class="block-top">
                    ...
                    <div class="main-text">
                        <div class="main-text-ct">
                            <div>
                                <span class="sitename">NQ Mobile </span>
                                <p>được thành lập từ năm 2024, là chuỗi bán lẻ <b>thiết bị di động</b> có <b>thị phần số 1
                                        Việt Nam</b> với {{ count($danhSachCuaHang) }} điểm
                                    bán thiết bị di động (bao gồm {{ count($danhSachCuaHang) }} cửa hàng NQ Mobile).<br></p>
                            </div>
                        </div>
                    </div>
                </div>
                <ul class="block-number">
                    <li>
                        ...
                        <div class="li-txt">
                            ...
                            <p class="txt02">CỬA HÀNG TRÊN<br>TP.HÀ NỘI</p>
                        </div>
                    </li>
                    <li>
                ...
                <div class="block-website">
                    <a href="/" class="block-website-item" target="_blank">
                        ...
                        Website: <span>www.nqmobile.com</span>
                    </a>
                </div>
            </div>
        </div>
