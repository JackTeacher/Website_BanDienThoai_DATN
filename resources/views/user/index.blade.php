...
@section('content')
    <div class="big-banner">
        <script src="//embed.bannerboo.com/b99a3ac46cc38/" async></script>
    </div>
    <div class='banner'>
        <section>
                    ...
                    <div class="stage"
                        ...
                        <div class="banner-item" style="width: 800px;">
                            <div class="item">
                                <a aria-label="slide" href="#">
                                    <img width="800" height="200"
                                        src="{{ asset('assets/user/images/banner-6.png') }}" />
                                </a>
                            </div>
                        </div>
                    </div>
    ...
    <section class="wrapper content-2 ct-11-11 hotsale-fs">
        <div class="container product boxfs" style="width: 1200px;">
            <h3 class="title" id="top-deal-soc">
                ...
                {{-- <img src="{{ asset('assets/user/images/quangcaosale.png') }}" --}}
        ...
        <div class="title"
            style="margin-top:5px;height:120px;background-image:url('{{ asset('assets/user/images/Hotsale-1200x120.jpg') }}')"
            id="dtdd"></div>
                ...
                <section>
                    <div class="box-quicklink" style="background: #fff;border-bottom: 1px solid #f3f3f3 !important;">
                        <div class="lst-quickfilter wrap" style="margin-top: 10px;margin-left: 33px;">
                            ...
                            <a href="javascript:filterProduct(11);" class="box-quicklink__item bd-radius quicklink-logo">
                                <img src="{{ asset('assets/user/images/logo-huawei.png') }}" class="no-text"
                                    width="30">
                            </a>
                            <a href="javascript:filterProduct(12);" class="box-quicklink__item bd-radius quicklink-logo">
                                <img src="{{ asset('assets/user/images/logo-sony.png') }}" class="no-text"
                                    width="30">
                            </a>
                            <a href="javascript:filterProduct(13);" class="box-quicklink__item bd-radius quicklink-logo">
                                <img src="{{ asset('assets/user/images/logo-lg.png') }}" class="no-text"
                                    width="30">
                            </a>
                            <a href="javascript:filterProduct(14);" class="box-quicklink__item bd-radius quicklink-logo">
                                <img src="{{ asset('assets/user/images/logo-honor.png') }}" class="no-text"
                                    width="30">
                            </a>
                            <a href="javascript:filterProduct(15);" class="box-quicklink__item bd-radius quicklink-logo">
                                <img src="{{ asset('assets/user/images/logo-tecno.png') }}" class="no-text"
                                    width="30">
                            </a>
