...
<body>
    <div class="detail-order">
        ...
        <div class="title">
                <p style="font-weight:bold; float:center ">HÓA ĐƠN BÁN HÀNG</p>
            ...
            <div style="float:right"><img src="{{ public_path('assets/user/images/Logo-2.png') }}" width="100px"></div>
            <div class="nqp">
        ...
        <div class="pbh">
            ...
            <p>Sản phẩm được bảo hành theo chính sách hãng tại tất cả các trung tâm bảo hành của hãng hoặc tại cửa hàng
                ...
                1234, tại tất cả các cửa hàng của NQ Mobile.</p>
        </div>
    </div>
</body>
