            ...
            if (empty($tontai)) {
                ...
                if ($dienThoai->save() == true) {
                    ...
                    if ($request->hasFile('hinhanhdaidien')) {
                        ...
                        $request->file('hinhanhdaidien')->storeAs('public/images/' . $tenThuongHieu->ten_thuong_hieu . '/' . $dienThoai->ten_san_pham .'/HinhAnhDaiDien', $request->file('hinhanhdaidien')->getClientOriginalName());
                        $hinhAnhDaiDien->hinh_anh = $tenThuongHieu->ten_thuong_hieu . '/' . $dienThoai->ten_san_pham . '/HinhAnhDaiDien/'.  $request->file('hinhanhdaidien')->getClientOriginalName();
                    } else {
                    ...
                    if ($hinhAnhDaiDien->save() == true) {
                        ...
                        if ($request->hasFile('hinhanhmohop')) {
                            $request->file('hinhanhmohop')->storeAs('public/images/' . $tenThuongHieu->ten_thuong_hieu . '/' . $dienThoai->ten_san_pham .'/HinhAnhMoHop', $request->file('hinhanhmohop')->getClientOriginalName());
                            $hinhAnhMoHop->hinh_anh = $tenThuongHieu->ten_thuong_hieu . '/' . $dienThoai->ten_san_pham .'/HinhAnhMoHop/'. $request->file('hinhanhmohop')->getClientOriginalName();
                        } else {
                        ...
                        if ($hinhAnhMoHop->save() == true) {
                            ...
                            if ($request->hasFile('hinhanhthongsokythuat')) {
                                $request->file('hinhanhthongsokythuat')->storeAs('public/images/' . $tenThuongHieu->ten_thuong_hieu . '/' . $dienThoai->ten_san_pham .'/HinhAnhThongSoKyThuat', $request->file('hinhanhthongsokythuat')->getClientOriginalName());
                                $hinhAnhThongSoKyThuat->hinh_anh = $tenThuongHieu->ten_thuong_hieu . '/' . $dienThoai->ten_san_pham .'/HinhAnhThongSoKyThuat/'. $request->file('hinhanhthongsokythuat')->getClientOriginalName();
                            } else {
