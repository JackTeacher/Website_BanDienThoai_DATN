...
class GioHangController extends Controller
{
        ...
        if ($request->phuongThuc == 1) {
            if (Session('Cart')->deliveryMethod['cachThucNhan'] == 1) {
                ...
                <div class="ordercontent">
                    <p>Cảm ơn ' . $gioiTinh . ' <b>' . Session('Cart')->infoUser['hoTen'] . '</b> đã cho NQ Mobile cơ hội được phục vụ.</p>
                    <div>
    ...
    public function vnpay_payment()
    {
        ...
        $vnp_TmnCode = "FOC24Y2G"; //Mã website tại VNPAY
        $vnp_HashSecret = "H4UFII6JTCSTKCJWU90SLW3LZINCL1A5"; //Chuỗi bí mật
